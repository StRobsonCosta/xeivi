...
public class OwnerController {
  ...
  public ResponseEntity<ProductDto> createProduct(@RequestBody ProductDto dto) {
    ...
    return ResponseEntity.ok(
        new ProductDto(saved.getId(), saved.getName(), saved.getDescription(), saved.getPrice()));
  }
  ...
  public ResponseEntity<ServiceOfferDto> createService(@RequestBody ServiceOfferDto dto) {
    ...
    return ResponseEntity.ok(
        new ServiceOfferDto(
            saved.getId(), saved.getName(), saved.getDescription(), saved.getPrice()));
  }

  @PutMapping("/services/{id}")
  @Transactional
  public ResponseEntity<ServiceOfferDto> updateService(
      @PathVariable Long id, @RequestBody ServiceOfferDto dto) {
    ServiceOffer s =
