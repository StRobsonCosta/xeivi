...
public class UserService {
    ...
    public UserService(UserRepository repo, CustomerRepository customerRepo) { this.repo = repo; this.customerRepo = customerRepo; }
    ...
    public void ensureDefaultAdmin() {
        ...
        if (repo.findByUsername(adminUsername).isEmpty()) {
            ...
            u.setRole("DONO");
            repo.save(u);
            System.out.println("Created default admin user 'admin' with password 'admin' (change in production)");
        }
    }
}
