...
import { AppointmentRequest, AppointmentResponse, Product, ServiceOffer, Barber } from '../../shared/models';
...
export class ClientComponent implements OnInit {
  ...
  onBarberOrDateChange(): void {
    ...
    this.api.get<string[]>(`/api/clients/availability?barberId=${this.request.barberId}&date=${date}`).subscribe({
